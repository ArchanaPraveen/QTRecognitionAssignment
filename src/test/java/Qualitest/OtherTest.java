...
public class OtherTest extends Index{
	...
	public void TestCase4() throws InterruptedException
	{
		...
		Thread.sleep(4000);
		String text=obj6.driver.findElement(By.xpath("//*[@id=\'display_message\']/span/center")).getText();
		System.out.println(text);//if card not selected
		log.info("card is not selected");
		String actual="Please select any image.";
